...
function sn(i, t, e) {
  ...
  const r = Et(t), o = Fn(t), l = Dn(o), a = J(t), c = r === "y", u = s.x + s.width / 2 - n.width / 2, d = s.y + s.height / 2 - n.height / 2, f = s[l] / 2 - n[l] / 2;
  let p;
  switch (a) {
    case "top":
      p = {
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if ((e = r.arrow) != null && e.alignmentOffset)
        return {};
      const S = J(n), E = Et(l), x = J(l) === l, $ = await (a.isRTL == null ? void 0 : a.isRTL(c.floating)), O = f || (x || !v ? [Ce(l)] : Qs(l)), _ = b !== "none";
      !f && _ && O.push(...Gs(l, v, b, $));
    ...
    async fn(t) {
      ...
      function b() {
        ...
        if (d.length >= 2) {
          ...
          const g = J(e) === "left", S = X(...d.map((A) => A.right)), E = Rt(...d.map((A) => A.left)), x = d.filter((A) => g ? A.left === E : A.right === S), $ = x[0].top, O = x[x.length - 1].bottom, _ = E, L = S, D = L - _, F = O - $;
          return {
            top: $,
            bottom: O,
            left: _,
...
async function er(i, t) {
  const {
    ...
    platform: s,
    elements: n
  } = i, r = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), o = J(e), l = Ne(e), a = Et(e) === "y", c = ["left", "top"].includes(o) ? -1 : 1, u = r && a ? -1 : 1, d = ce(t, i);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: b
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: s
      }, u = await Un(t, a), d = Et(J(n)), f = Hn(d);
      let p = c[f], b = c[d];
      if (r) {
...
function Qn(i) {
  return He() ? i instanceof Node || i instanceof z(i).Node : false;
}
function Y(i) {
  return He() ? i instanceof Element || i instanceof z(i).Element : false;
}
function G(i) {
  return He() ? i instanceof HTMLElement || i instanceof z(i).HTMLElement : false;
}
function rn(i) {
  return !He() || typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof z(i).ShadowRoot;
}
function ue(i) {
  const {
    overflow: t,
...
function ur(i) {
  ...
  const r = n === "fixed", o = gt(s), l = t ? Kn(t.floating) : false;
  if (s === o || l && r)
    return e;
  let a = {
    scrollLeft: 0,
...
function dr(i) {
  const t = gt(i), e = Fe(i), s = i.ownerDocument.body, n = X(t.scrollWidth, t.clientWidth, s.scrollWidth, s.clientWidth), r = X(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight);
  let o = -e.scrollLeft + Zn(i);
  const l = -e.scrollTop;
  return j(s).direction === "rtl" && (o += X(t.clientWidth, s.clientWidth) - n), {
    width: n,
    height: r,
    x: o,
    y: l
...
function pr(i, t) {
  const e = ee(i, true, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = G(i) ? It(i) : ct(1), o = i.clientWidth * r.x, l = i.clientHeight * r.y, a = n * r.x, c = s * r.y;
  return {
    width: o,
    height: l,
    x: a,
...
function ts(i, t) {
  const e = zt(i);
  return e === t || !Y(e) || De(e) ? false : j(e).position === "fixed" || ts(e, t);
}
function mr(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = oi(i, [], false).filter((l) => Y(l) && ut(l) !== "body"), n = null;
...
var _e = globalThis;
var xi = _e.ShadowRoot && (_e.ShadyCSS === void 0 || _e.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var wi = Symbol();
var an = /* @__PURE__ */ new WeakMap();
var os = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = true, s !== wi)
...
var wr = (i) => new os(typeof i == "string" ? i : i + "", void 0, wi);
var C = (i, ...t) => {
...
var cn = xi ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
...
var at = globalThis;
var un = at.trustedTypes;
var Pr = un ? un.emptyScript : "";
...
var $i = (i, t) => !Cr(i, t);
var hn = { attribute: true, type: String, converter: Ee, reflect: false, hasChanged: $i };
...
var dn = Se ? Se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var ls = "$lit$";
...
var Lr = (i) => Ci(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Je = `[ 	
\f\r]`;
...
function jt(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((l = n == null ? void 0 : n._$AO) == null || l.call(n, false), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = jt(i, n._$AS(i, t.values), n, s)), t;
}
var Mr = class {
  constructor(t, e) {
...
var Nn;
w._$litElement$ = true, w.finalized = true, (Nn = globalThis.litElementHydrateSupport) == null || Nn.call(globalThis, { LitElement: w });
var Ze = globalThis.litElementPolyfillSupport;
Ze == null || Ze({ LitElement: w });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
var Hr = { attribute: true, type: String, converter: Ee, reflect: false, hasChanged: $i };
var Dr = (i = Hr, t, e) => {
...
var hs = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
...
function Xo(i = "iconify-icon") {
  ...
  const n = [
    ...
    */
     ...
     */
    _gotIconData(a) {
      this._checkQueued = false, this._renderIcon(a, vn(this), this.getAttribute("mode"));
    }
    /**
...
var Hi = class Hi2 extends w {
  ...
  onSliderMouseDown(t) {
    ...
    const r = (a) => {
      ...
      document.removeEventListener("mousemove", r), document.body.style.cursor = "default", n ? n = false : (this.addEventListener("blur", o), this.slider = false, requestAnimationFrame(() => this.focus())), document.removeEventListener("mouseup", l);
    };
